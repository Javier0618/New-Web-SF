...
(function () {
  ...
  function initDonationModal() {
    ...
    var floatingAndroidBtn = document.getElementById("floating-android-btn");
    ...
    function downloadAPK() {
      window.open("https://streamfusion.top/down/AI2KOBT1bNck.apk", "_blank");
    }

    // Agregar event listeners
    floatingDonationBtn.onclick = openModal; // CAMBIO AQUÍ
    if (floatingAndroidBtn) floatingAndroidBtn.onclick = downloadAPK;
